...
//         <div>
//           <div className='text-green-600 font-semibold text-4xl'>Linea Street</div>
//           <div className='text-neutral-400'>Find the best Flow.fun tokens and track latest migrations</div>
//         </div>
...
const Homepage = () => {
  ...
  return (
    <div className='bg-slate-950'>
      ...
      <div className='flex justify-between px-9 py-8'>
        <div>
          <div className='text-green-600 font-semibold text-4xl'>Flow.fun</div>
          <div className='text-neutral-400'>Find the best Flow.fun tokens and track latest migrations</div>
        </div>
